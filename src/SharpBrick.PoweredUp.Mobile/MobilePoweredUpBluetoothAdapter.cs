...
{
    public class MobilePoweredUpBluetoothAdapter : IPoweredUpBluetoothAdapter
    {
        ...
        public MobilePoweredUpBluetoothAdapter(IBluetoothLE bluetooth, INativeDeviceInfoProvider deviceInfoProvider)
        {
        ...
        public void Discover(Func<IPoweredUpBluetoothDeviceInfo, Task> discoveryHandler, CancellationToken cancellationToken = default)
        {
            ...
            {
                var info = new MobileBluetoothDeviceInfo();
        ...
        private void AddInternalDevice(IDevice device, MobileBluetoothDeviceInfo info)
        {
        ...
        {
            var deviceId = (bluetoothDeviceInfo is MobileBluetoothDeviceInfo local) ? local.DeviceIdentifier : throw new ArgumentException("DeviceInfo not created by adapter", nameof(bluetoothDeviceInfo));
            ...
            return new MobilePoweredUpBluetoothDevice(_discoveredDevices[deviceId], _bluetoothAdapter);
        }
        ...
        public Task<IPoweredUpBluetoothDeviceInfo> CreateDeviceInfoByKnownStateAsync(object state)
            ...
            {
                ulong address => new MobileBluetoothDeviceInfo() { DeviceIdentifier = address.ToString() },
                string id => new MobileBluetoothDeviceInfo() { DeviceIdentifier = id },
                _ => null,
            });
    }
}
