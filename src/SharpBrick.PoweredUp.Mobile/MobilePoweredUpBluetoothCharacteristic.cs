...
{
    public class MobilePoweredUpBluetoothCharacteristic : IPoweredUpBluetoothCharacteristic
    {
        private readonly ICharacteristic _characteristic;

        public Guid Uuid => _characteristic.Id;

        public MobilePoweredUpBluetoothCharacteristic(ICharacteristic characteristic)
        {
