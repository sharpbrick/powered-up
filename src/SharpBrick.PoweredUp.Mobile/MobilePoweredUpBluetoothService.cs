...
{
    public class MobilePoweredUpBluetoothService : IPoweredUpBluetoothService
    {
        private IService _service;

        public Guid Uuid => _service.Id;

        public MobilePoweredUpBluetoothService(IService service)
        {
        ...
        ~MobilePoweredUpBluetoothService() => Dispose(false);
