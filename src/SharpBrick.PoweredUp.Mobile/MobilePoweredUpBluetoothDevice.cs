...
namespace SharpBrick.PoweredUp.Mobile
{
    public class MobilePoweredUpBluetoothDevice : IPoweredUpBluetoothDevice
    {
        ...
        public MobilePoweredUpBluetoothDevice(IDevice device, IAdapter bluetoothAdapter)
        {
            this._device = device;
        ...
        ~MobilePoweredUpBluetoothDevice() => Dispose(false);
        ...
        public async Task<IPoweredUpBluetoothService> GetServiceAsync(Guid serviceId)
        {
            ...
            return new MobilePoweredUpBluetoothService(service);
        }
    }
}
