...
public class TechnicMediumAngularMotorGrey : AbsoluteMotor, IPoweredUpDevice
{
    public TechnicMediumAngularMotorGrey()
        : base()
    { }
    public TechnicMediumAngularMotorGrey(ILegoWirelessProtocol protocol, byte hubId, byte portId)
