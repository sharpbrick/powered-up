...
namespace SharpBrick.PoweredUp.Protocol.Formatter
{
    public class HubPropertiesEncoderTest
    {
        ...
        [InlineData("06-00-01-07-06-00", HubProperty.BatteryType, HubPropertyOperation.Update, HubPropertyBatteryType.Normal)]
        [InlineData("06-00-01-07-06-01", HubProperty.BatteryType, HubPropertyOperation.Update, HubPropertyBatteryType.RechargeableBlock)]
